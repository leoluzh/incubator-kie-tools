...
- `BUILDER_IMAGE_ARG`: The base image used for building this image (defaults to `registry.redhat.io/ubi9/openjdk-17:1.23`).
  - Tested with:
    - registry.redhat.io/ubi9/openjdk-17:1.23
